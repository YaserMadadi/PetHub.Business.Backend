...
public class Provider_Service : Service<Provider>, IProvider_Service
{
    public Provider_Service() : base()
    {
    }

    public override async Task<DataResult<Provider>> SaveAttached(Provider provider, UserCredit userCredit)
    {
        return await provider.SaveAttached(userCredit);
    }
