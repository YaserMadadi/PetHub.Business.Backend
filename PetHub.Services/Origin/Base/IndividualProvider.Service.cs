...
public class IndividualProvider_Service : Service<IndividualProvider>, IIndividualProvider_Service
{
    public IndividualProvider_Service() : base()
    {
    }

    public override async Task<DataResult<IndividualProvider>> SaveAttached(IndividualProvider individualProvider, UserCredit userCredit)
    {
        return await individualProvider.SaveAttached(userCredit);
    }
