...
namespace PetHub.ApiServices.ExtendedControllers.Admin;

[Route("api/Admin")]
public class MenuController : BaseController
{
    public MenuController(IMenu_ExtendedService menuService)
    {
        this.menuService = menuService;
    }

    private IMenu_ExtendedService menuService { get; set; }

    [HttpGet]
    [Route("Menu/LoadMenuByUserType/{id:int}")]
    public async Task<IActionResult> LoadMenu(int id)
    {
        var result = await this.menuService.LoadMenu(id, this.UserCredit);
